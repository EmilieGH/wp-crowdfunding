        ...
        if(isset( $value['type'] )){
            switch ( $value['type'] ) {
                ...
                case 'checkbox':
                    ...
                    $output .= '<td>';
                    $var = get_option( $value['id'] );
                    $output .= '<input type="checkbox" name="'.$value['id'].'" id="'.$value['id'].'" value="true" '.($var=="true"?"checked='checked'":"").'/>';
...
function neo_crowdfunding_go_premium(){
    ...
    $html .= '<li class="dashicons-before dashicons-yes"><span>Authorize.net (AIM) Support</span> -  Support Authorize.net (AIM) Support.</li>';
    ...
    $html .= '<li class="dashicons-before dashicons-yes"><span>1 Free Theme</span> - You will get a free WordPress Crowdfunding theme.</li>';
    $html .= '</ul>';
    ...
    if( 'true' == get_option('wpneo_enable_color_styling') ){
        ...
        if( $button_bg ){
            ...
            $style .= '.wpneo_donate_button:hover, 
                        ...
                        .wpneo_donate_button:hover{ background-color:'.$button_bg_hover.' !important; color:'.$text_hover_color.' !important; }';
        }
        ...
        if( $color_scheme ){
            $style .=  '#neo-progressbar > div,
                        ...
                        .wpneo-tabs-menu li.wpneo-current {
                            border-bottom: 3px solid '.$color_scheme.'  !important;
                        }
                        .wpneo-link-style1,
            ...
            $style .=  '.tab-rewards-wrapper .overlay {
                            background: rgba('.$r.','.$g.','.$b.',.9) !important;
                        }';
        }
...
function neo_crowdfunding_register_menu_page(){
    add_menu_page( __( 'Crowdfunding settings', 'wp-crowdfunding' ),'Crowdfunding','manage_options','wpneo-crowdfunding','neo_crowdfunding_menu_page','dashicons-admin-multisite', null );
